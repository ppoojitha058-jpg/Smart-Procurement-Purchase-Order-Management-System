...
public interface PurchaseRequestService {
    ...
    // Filter methods
    List<PurchaseRequest> getRequestsByUser(String email);
    List<PurchaseRequest> getRequestsByDepartment(Long departmentId);
    List<PurchaseRequest> getRequestsByStatus(String status);

    // Manager actions
    List<PurchaseRequest> getPendingRequests();
    List<PurchaseRequest> getRequestsByManager(String managerEmail);
    List<PurchaseRequest> getPendingRequestsByDepartment(Long departmentId);
